                      ...
                      {menuItem.subMenuItems.map((subMenuItem, index) => (
                        <li key={index} className="leading-none">
                          <CustomLink
                            ...
                            className="flex min-h-[50px] items-center px-4 py-2 pr-6 text-[15px] font-normal capitalize text-accent-900  transition-colors duration-200 hover:bg-primary  dark:text-accent-900 "
                          >
                            {subMenuItem.label}
                          </CustomLink>
                        </li>
